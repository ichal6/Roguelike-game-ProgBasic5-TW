...
def run():
    ...
    Returns:
        None
    """
    list_of_games = inventory.get_data_to_list()
    ...
    while choice != "0":
        ...
        if choice == "1":
            ...
            new_record.insert(0, inventory.get_random_id(list_of_games))
            list_of_games = inventory.add(list_of_games, new_record)
        elif choice == "2":
            id_of_record_to_remove = ask_untill_correct(list_of_games)
            list_of_games = inventory.remove(list_of_games, common.check_id_by_number(list_of_games, int(id_of_record_to_remove)))
        elif choice == "3":
            ...
            list_of_games = inventory.update(list_of_games, common.check_id_by_number(list_of_games, int(id_of_record_to_update)), updated_record)
        elif choice == "4":
            pass
        elif choice == "5":
            pass
        elif choice == "0":
            inventory.export_list_to_file(list_of_games)
        else:
